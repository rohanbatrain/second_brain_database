...
async def create_workspace_token_request(
    workspace_id: str,
    amount: int,
    reason: str
) -> Dict[str, Any]:
...
async def freeze_workspace_wallet(
    workspace_id: str,
    reason: str
) -> Dict[str, Any]:
    """
...
async def get_workspace_transaction_history(
    workspace_id: str,
    limit: int = 50
) -> List[Dict[str, Any]]:
    """
    ...
    try:
        ...
        await create_mcp_audit_trail(
            ...
            resource_id=workspace_id,
            metadata={
                "transaction_count": len(limited_transactions),
                "limit": limit
            }
        )
...
async def emergency_workspace_access(
    workspace_id: str,
    ...
    try:
        ...
        await create_mcp_audit_trail(
            ...
            metadata={
                "unfrozen_at": result.get("unfrozen_at"),
                "emergency": True
            }
        )
