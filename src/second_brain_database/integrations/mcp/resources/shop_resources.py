...
.resource("user://{user_id}/assets")
    ...
    @mcp.resource("user://{user_id}/transactions")
   ...
   @mcp.resource("user://{user_id}/sbd/balance")
    ...
    @mcp.resource("user://{user_id}/spending/analytics")
    ...
    @mcp.resource("user://{user_id}/assets/usage")
