...
class AuthLogger:
    ...
    def log_registration_attempt(self, username: str, email: str, ip_address: str = "", 
    ...
    def log_login_attempt(self, identifier: str, ip_address: str = "", 
                         success: bool = True, reason: Optional[str] = None,
                         mfa_required: bool = False, user_agent: str = ""):
    ...
    def log_logout_attempt(self, user_id: str, ip_address: str = "", 
                          success: bool = True, reason: Optional[str] = None):
    ...
    def log_password_reset_request(self, email: str, ip_address: str = "", 
                                  success: bool = True, reason: Optional[str] = None,
                                  suspicious: bool = False, abuse_reasons: Optional[list] = None):
        ...
        if suspicious:
            log_security_event(
                event_type="password_reset_suspicious",
                details=details,
                user_id=email,
                ip_address=ip_address
            )
    ...
    def log_email_verification(self, user_id: str, email: str, ip_address: str = "", 
                              success: bool = True, reason: Optional[str] = None):
    ...
    def log_2fa_setup(self, user_id: str, ip_address: str = "", 
                     success: bool = True, reason: Optional[str] = None):
    ...
    def log_2fa_verification(self, user_id: str, method: str, ip_address: str = "", 
                           success: bool = True, reason: Optional[str] = None):
    ...
    def log_token_operation(self, user_id: str, operation: str, token_type: str = "access",
