...
class PermanentTokenAuditLogger:
    ...
    async def log_event(
        ...
        try:
            ...
            await collection.insert_one(asdict(audit_event))
    ...
    async def log_token_revocation(
        ...
        await self.log_event(
            ...
            user_agent=user_agent,
            details={
                "revocation_reason": revocation_reason or "user_requested",
...
async def log_token_created(user_id: str, username: str, token_id: str, token_hash: str, 
                           ip_address: str = None, user_agent: str = None, description: str = None):
    """Log token creation event."""
    await audit_logger.log_token_creation(user_id, username, token_id, token_hash, 
                                         ip_address, user_agent, description)


async def log_token_validated(user_id: str, username: str, token_id: str, token_hash: str,
                             ip_address: str = None, user_agent: str = None, 
                             cache_hit: bool = False, response_time_ms: float = None):
    """Log token validation event."""
    await audit_logger.log_token_validation(user_id, username, token_id, token_hash,
                                           ip_address, user_agent, cache_hit, response_time_ms)


async def log_token_revoked(user_id: str, username: str, token_id: str, token_hash: str,
                           ip_address: str = None, user_agent: str = None, reason: str = None):
    """Log token revocation event."""
    await audit_logger.log_token_revocation(user_id, username, token_id, token_hash,
                                           ip_address, user_agent, reason)


async def log_validation_failed(token_hash: str, ip_address: str = None, user_agent: str = None,
                               failure_reason: str = "invalid_token", error_message: str = None):
    """Log validation failure event."""
    await audit_logger.log_validation_failure(token_hash, ip_address, user_agent, 
                                             failure_reason, error_message)


async def log_suspicious_activity(description: str, user_id: str = None, username: str = None,
                                 ip_address: str = None, user_agent: str = None, details: Dict[str, Any] = None):
    """Log suspicious activity event."""
    await audit_logger.log_suspicious_activity(description, user_id, username, 
