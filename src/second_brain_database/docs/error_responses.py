                ...
                "common_issues": [
                    {
                        ...
                        "solutions": ["Refresh your JWT token", "Check token format", "Include 'Authorization: Bearer <token>' header"]
                    },
                    {
                        "issue": "422 Validation Error",
                        "causes": ["Invalid field values", "Missing required fields", "Wrong data types"],
                        "solutions": ["Check field requirements", "Validate data before sending", "Review API documentation"]
                    },
                    {
                        "issue": "429 Rate Limit",
                        "causes": ["Too many requests", "Exceeded quota"],
                        "solutions": ["Implement rate limiting in client", "Use exponential backoff", "Consider upgrading plan"]
                    }
                ]
            }
        }
