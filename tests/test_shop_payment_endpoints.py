...
async def _create_test_family(client, user_token, family_token, test_user, family_user):
    ...
    response = client.post(f"/family/invitation/{invitation_id}/respond",
    ...
    await family_manager.update_spending_permissions(
        ...
        {
            "can_spend": True,
            "spending_limit": 200  # Limited spending for testing
        }
    )
...
class TestShopPaymentEndpoints:
    ...
    def test_payment_options_endpoint(self, mock_get_family_sbd_account, mock_get_user_families, mock_get_collection, mock_get_current_user):
    ...
    async def test_theme_purchase_personal_new_format(self):
        ...
        purchase_data = {
            "theme_id": "emotion_tracker-pacificBlue",
            "payment_method": {
                "type": "personal"
            }
        }
    ...
    async def test_theme_purchase_family_success(self):
        ...
        headers = {
            "Authorization": f"Bearer {self.family_token}",
            "user-agent": "emotion_tracker/1.0.0"
        }
    ...
    async def test_theme_purchase_family_exceeds_limit(self):
        ...
        await family_manager.update_spending_permissions(
            ...
            {
                "can_spend": True,
                "spending_limit": 200  # Theme costs 250, so this should fail
            }
        )
    ...
    async def test_theme_purchase_invalid_client(self):
        ...
        headers = {
            "Authorization": f"Bearer {self.user_token}",
            "user-agent": "invalid_client/1.0.0"
        }

        purchase_data = {
            "theme_id": "emotion_tracker-crimsonRed",
            "payment_method": {
                "type": "personal"
            }
        }
    ...
    async def test_bundle_purchase_with_auto_population(self):
        ...
        purchase_data = {
            "bundle_id": "emotion_tracker-avatars-cat-bundle",
            "payment_method": {
                "type": "personal"
            }
        }
    ...
    async def test_cart_checkout_functionality(self):
        ...
        headers = {
            "Authorization": f"Bearer {self.user_token}",
            "user-agent": "emotion_tracker_app/1.0.0"
        }
...
class TestShopPaymentSystemErrorProof:
    ...
    async def test_db_setup(self):
        ...
        # Create test family
        test_family_id = await _create_test_family(
    ...
    async def test_personal_payment_success(self, setup_test_data):
        ...
        headers = {
            "Authorization": f"Bearer {data['user_token']}",
            "user-agent": "emotion_tracker/1.0.0"
        }

        purchase_data = {
            "theme_id": "emotion_tracker-oceanBlue",
    ...
    async def test_family_payment_success(self, setup_test_data):
        ...
        data = setup_test_data
        headers = {
            "Authorization": f"Bearer {data['family_token']}",
            "user-agent": "emotion_tracker/1.0.0"
        }
    ...
    async def test_insufficient_personal_tokens(self, setup_test_data):
        ...
        await users_collection.update_one(
            ...
            {"$set": {"sbd_tokens": 100}}  # Less than theme price of 250
        )
        ...
        purchase_data = {
            "theme_id": "emotion_tracker-sunsetOrange",
            "payment_method": {"type": "personal"}
        }
    ...
    async def test_family_frozen_account(self, setup_test_data):
        ...
        await family_manager.freeze_family_account(
            data["test_family_id"],
            data["test_user"]["username"],
            "Test freeze for payment testing"
        )
    ...
    async def test_already_owned_theme(self, setup_test_data):
        ...
        purchase_data = {
            "theme_id": "emotion_tracker-lavenderPurple",
            "payment_method": {"type": "personal"}
        }
    ...
    async def test_invalid_client_user_agent(self, setup_test_data):
        ...
        purchase_data = {
            "theme_id": "emotion_tracker-coralRed",
            "payment_method": {"type": "personal"}
        }
    ...
    async def test_bundle_purchase_auto_population(self, setup_test_data):
        ...
        purchase_data = {
            "bundle_id": "emotion_tracker-avatars-dog-bundle",
            "payment_method": {"type": "personal"}
        }
    ...
    async def test_transaction_logging(self, setup_test_data):
        ...
        purchase_data = {
            "theme_id": "emotion_tracker-log-test",
            "payment_method": {"type": "personal"}
        }
        ...
        transaction = await transactions_collection.find_one({
            "user_id": data["test_user"]["username"],
    ...
    async def test_invalid_payment_method_types(self, setup_test_data):
        ...
        purchase_data = {
            "theme_id": "emotion_tracker-invalid-payment",
            "payment_method": {"type": "invalid_type"}
        }
