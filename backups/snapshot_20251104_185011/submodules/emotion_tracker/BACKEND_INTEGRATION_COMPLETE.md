# Flutter Backend Integration Documentation
...
1. **Immediate (Today):**
   - [x] Update all endpoint URLs to use correct backend paths
   - [x] Implement BackendDataMapper utility
   - [x] Update API service layer with new endpoints
   - [x] Test wallet initialization, settings, and token requests
